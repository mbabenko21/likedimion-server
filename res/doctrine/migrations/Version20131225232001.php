 ...
 */
class Version20131225232001 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE account_players (account_id INT NOT NULL, player_id INT NOT NULL, INDEX IDX_EF6557EE9B6B5FBA (account_id), INDEX IDX_EF6557EE99E6F5DF (player_id), PRIMARY KEY(account_id, player_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("ALTER TABLE account_players ADD CONSTRAINT FK_EF6557EE9B6B5FBA FOREIGN KEY (account_id) REFERENCES accounts (id)");
        $this->addSql("ALTER TABLE account_players ADD CONSTRAINT FK_EF6557EE99E6F5DF FOREIGN KEY (player_id) REFERENCES players (id)");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE account_players DROP FOREIGN KEY FK_EF6557EE9B6B5FBA");
        ...
        $this->addSql("ALTER TABLE account_players DROP FOREIGN KEY FK_EF6557EE99E6F5DF");
        ...
        $this->addSql("DROP TABLE account_players");
